...
| **P8b-2** | RQ4 (Exp-4/5/6) | đánh giá | ✅ **xong branch `phase8b2`** — Exp-4 (drift+retrain ON/OFF, sudden+gradual detect, recurring=limitation), Exp-5 (swap IForest↔LSTM-AE: LSTM-AE ROC-AUC 0.948>0.926, **Wilcoxon p=0.010**, swap 0-core), Exp-6 (3 mod handover: 1 file/0 regression mỗi mod); chạy thật → `*_summary.json` + bảng | RQ4a PARTIAL (2/3 drift) · RQ4b PASS · RQ4c PASS; số thật từ artifact; tiêu chí định trước | RQ4 |

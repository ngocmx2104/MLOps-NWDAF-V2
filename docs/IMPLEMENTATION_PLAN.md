...
| **P7** | CI/CD | C1 | GitHub Actions: feature→train→**eval-gate**→serve/deploy; tích hợp DVC | push trigger pipeline; eval-gate chặn model kém; deploy job chạy; đo DORA (lead time, MTTR) | RQ3 · maturity |

...
- **~185 test xanh, ruff sạch** (P0–P8a merged + P8b-1 trên branch `phase8b1`; 175 nhanh + 10 test thực nghiệm chạy **real-subprocess** nên suite chậm ~4 phút). Chạy `source .venv/bin/activate && pytest -q && ruff check .`.
